...
function Pmbsweb_Contact_Form() {
    ...
    // Contact Form
    if ( jQuery('.pmbsweb-contact-form:not(.is-init)').length ) {
        jQuery('.pmbsweb-contact-form:not(.is-init)').each(function() {
            let $form = jQuery(this),
                $response = $form.find('.pmbsweb-contact-form__response'),
                formData;
            ...
            $form.on('submit', function(e) {
                ...
                .done(function(response) {
                    ...
                    $response.empty().removeClass('pmbsweb-alert-danger').addClass('pmbsweb-alert-success').slideDown(200);
                ...
                .fail(function(data) {
                    $form.removeClass('is-busy');
                    $response.empty().removeClass('pmbsweb-alert-success').addClass('pmbsweb-alert-danger').slideDown(200);
